...
public class SJKZhuanLanAdapterNew1 extends MultiItemRecycleViewAdapter<Object> implements CalendarState {

    private static boolean isCal;
    private SpceColumnBean.DataBean  dataBean;
    public SJKZhuanLanAdapterNew1(Context context) {
        super(context, new SJKZhuanLanMultiItemTypeSupport());
        isCal = true;
    }

    public SJKZhuanLanAdapterNew1(Context context, SpceColumnBean.DataBean dataBean) {
        super(context, new SJKZhuanLanMultiItemTypeSupport() );
        isCal = false;
