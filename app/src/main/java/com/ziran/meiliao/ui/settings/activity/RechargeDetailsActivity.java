...
public class RechargeDetailsActivity extends BaseActivity {
    ...
    public static void startAction(Context mContext) {
        Intent intent = new Intent(mContext, RechargeDetailsActivity.class);
    ...
    public void initView() {
        ...
        ntb.setTitleText(getString(R.string.gold_detail));
        initFragment(new RechargeDetailsFragment());
    }
}
