...
public class ReportDetailActivity  extends CommonHttpActivity<CommonPresenter, CommonModel> implements CommonContract.ActionView<Result, Result>, BGASortableNinePhotoLayout.Delegate {
    ...
    public int getLayoutId() {
        return R.layout.ac_report_details;
    }
    ...
    public void returnData(Result result) {
        ...
        if(result instanceof StringDataV2Bean){
            StringDataV2Bean data = (StringDataV2Bean) result;
