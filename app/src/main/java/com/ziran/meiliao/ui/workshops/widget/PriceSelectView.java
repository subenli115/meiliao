...
public class PriceSelectView extends View {
    ...
    public PriceSelectView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static List<Item> getDefaultData() {
        ...
        items.add(new Item("500", 500));
        items.add(new Item("1k", 1000));
        items.add(new Item("2k", 2000));
        items.add(new Item("3k", 3000));
        items.add(new Item("5k", 5000));
        items.add(new Item("1w+", 10000));
