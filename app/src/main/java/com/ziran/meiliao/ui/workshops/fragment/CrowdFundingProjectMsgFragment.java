...
public class CrowdFundingProjectMsgFragment extends CommonHttpFragment<CrowdFundingProjectMsgPresenter, CommonModel> implements
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_crowd_funding_project_msg;
    }
