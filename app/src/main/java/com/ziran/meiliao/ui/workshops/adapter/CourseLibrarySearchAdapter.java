...
public class CourseLibrarySearchAdapter extends MultiItemRecycleViewAdapter<Object> {
    ...
    public CourseLibrarySearchAdapter(Context context) {
    ...
    private static class CourseLibraryTeamMultiItemType implements MultiItemTypeSupport<Object> {
        ...
        public int getItemViewType(int position, Object bean) {
            if (bean instanceof HeadData) {
                ...
                return ((CourseLibraryTeamBean) bean).getItemType();
            }
            return 0;
        }
    }
