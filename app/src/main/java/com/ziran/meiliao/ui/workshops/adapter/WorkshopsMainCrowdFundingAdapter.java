...
public class WorkshopsMainCrowdFundingAdapter extends CommonRecycleViewAdapter<CrownFundListBean> {

    public WorkshopsMainCrowdFundingAdapter(Context context) {
        super(context, R.layout.item_workshops_main_crowd_funding);
    }
...
//        helper.setImageUrlTarget(R.id.iv_item_workshops_main_crowd_funding_pic, AppConstant.URL,R.mipmap.ic_loading_square_big);
        ...
        helper.setText(R.id.tv_item_workshops_main_crowd_funding_date,bean.getTotalTime());
