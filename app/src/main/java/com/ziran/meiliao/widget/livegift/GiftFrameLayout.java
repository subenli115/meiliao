package com.ziran.meiliao.widget.livegift;
...
//        }
    ...
    public AnimatorSet startAnimation() {
        ...
        flyFromLtoR.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                if (mGift.getSendUserPic().equals("")){
                    Glide.with(mContext).load(R.mipmap.ic_member_pic).transform(new GlideCircleTransfromUtil(mContext)).into(anim_header);
                }else {
                    Glide.with(mContext).load(mGift.getSendUserPic()).transform(new GlideCircleTransfromUtil(mContext)).into(anim_header);
                }
        ...
        if (!mGift.getGiftPic().equals("")){
            Glide.with(mContext).load(mGift.getGiftPic()).placeholder(R.mipmap.ic_loading_rectangle).into(new SimpleTarget<GlideDrawable>() {
                @Override
