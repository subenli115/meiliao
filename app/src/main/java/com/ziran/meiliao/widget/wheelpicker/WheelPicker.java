package com.ziran.meiliao.widget.wheelpicker;
...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        extraText = a.getString(R.styleable.WheelPicker_wheel_select_item_extra_text);
        ...
        extraMargin = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_select_item_extra_text_margin,
                DisplayUtil.dip2px(getResources(),30));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (EmptyUtils.isNotEmpty(extraText)){
            ...
            canvas.drawText(extraText, mDrawnCenterX + extraMargin,( getHeight()/2+  (fontMetrics.descent- fontMetrics.ascent)/2 - fontMetrics.bottom) , mPaint);
        }
    ...
    public void setExtraText(String text){
        if (EmptyUtils.isNotEmpty(text) && !text.equals(extraText)){
            this.extraText = text;
            invalidate();
        }
    }
    ...
    public Object getSelectData(){
        return mData.get(getCurrentItemPosition());
    }
    public String getSelectString(){
        return mData.get(getCurrentItemPosition()).toString();
    }
    @Override
    ...
    public void setmCurrentItemPosition(int currentItemPosition){
