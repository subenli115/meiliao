...
public class CustomNumbersView extends LinearLayout {
    ...
    public CustomNumbersView(Context context) {
        this(context, null);
    }

    public CustomNumbersView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomNumbersView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        rootView = LayoutInflater.from(context).inflate(R.layout.custom_numbers2, this, true);
