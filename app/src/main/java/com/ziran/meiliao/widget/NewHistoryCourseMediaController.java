...
public class NewHistoryCourseMediaController extends FrameLayout implements IMediaController, IMyMediaController {
    ...
    public NewHistoryCourseMediaController(@NonNull Context context) {
        this(context, null);
    }

    public NewHistoryCourseMediaController(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewHistoryCourseMediaController(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
