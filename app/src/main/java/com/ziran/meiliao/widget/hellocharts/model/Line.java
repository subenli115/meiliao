...
import com.ziran.meiliao.widget.hellocharts.formatter.LineChartValueFormatter;
import com.ziran.meiliao.widget.hellocharts.formatter.SimpleLineChartValueFormatter;
...
public class Line {
    ...
    private int darkenColor = ChartUtils.DEFAULT_DARKEN_COLOR; //变暗
