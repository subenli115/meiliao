...
public class ExpandableTextView extends AppCompatTextView {
    ...
    private static final int TO_EXPAND_HINT_COLOR = 0xFF45B000;
    private static final int TO_SHRINK_HINT_COLOR = 0xFF45B000;
    ...
    private void init() {
        ...
        setCompoundDrawablePadding(DisplayUtil.dip2px(4));
...
//        }
        ...
        ViewUtil.addOnGlobalLayoutListener(this, new ViewUtil.BaseCallBack() {
            @Override
            public void call() {
    ...
    private CharSequence getNewTextByConfig(){
        ...
        switch (mCurrState){
            case STATE_SHRINK: {
                ...
                setCompoundDrawablesWithIntrinsicBounds(0,0,0,R.mipmap.course_arrow_down);
            ...
            case STATE_EXPAND: {
                ...
                setCompoundDrawablesWithIntrinsicBounds(0,0,0,R.mipmap.course_arrow_up);
