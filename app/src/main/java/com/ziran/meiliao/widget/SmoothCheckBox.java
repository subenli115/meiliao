...
//    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#DFDFDF");
    ...
    private void init(AttributeSet attrs) {
        ...
        openAnimation = ta.getBoolean(R.styleable.SmoothCheckBox_open_animation, false);
        mChecked = ta.getBoolean(R.styleable.SmoothCheckBox_scb_checked, false);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, (int) DisplayUtil.dp2px(getResources(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = (int) DisplayUtil.dp2px(getResources(), DEF_DRAW_SIZE);
