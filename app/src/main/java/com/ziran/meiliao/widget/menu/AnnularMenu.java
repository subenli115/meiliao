package com.ziran.meiliao.widget.menu;
...
public class AnnularMenu extends ViewGroup implements View.OnClickListener {
    ...
    private static final int DEFAULT_TOGGLE_DURATION = 400;
...
//        ScaleAnimation scaleAnimation = new ScaleAnimation(1.0f, 2.5f, 1.0f, 2.5f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5F);
    ...
    private void changeStatus() {
        ShadowImageView iv = (ShadowImageView) mCButton;
        if (isOpen()){
            iv.setImageResource(R.mipmap.mdflnes_more);
        }else{
            iv.setImageResource(R.mipmap.ic_close);
        }
        rotateCButton(iv, 0f, 180f, 400);
