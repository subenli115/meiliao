 ...
 * updateDes
 */
public class BottomMbsrView extends CustomRelativeLayout implements MoreImageView.OnMoreImageViewClickListener {
    /**
     * 剪切控件内的标题
     */
...
//    private ImageView ivExerciseShareQrCode;
    ...
    public BottomMbsrView(Context context) {
        this(context, null);
    }

    public BottomMbsrView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public BottomMbsrView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected int getResourseLayoutId() {
        return R.layout.custom_exercise_view1;
    }
...
//        setDate(System.currentTimeMillis());
    ...
    public void setTitleText(String minute,String word,String title) {
...
//        number.put("id",id);
//        number.put("itemId",itemId);
//        //上传图片到服务器
//        OkHttpClientManager.postContentAndFiles(ApiKey.PRACTIEACTIVITY_UPLOADPRACTICEBOOKS, number, FileUtil.str2File(shotFilePath), new
...
//                    //启动分享
//                    ShareUtil.shareImage(getContext(),shareMedia,data.getShareDescribe(),new File(shotFilePath),null,shotFilePath);
//                    setVisibility(VISIBLE);
//
//                }
//            }
