...
public abstract class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attrs) {
        ...
        setRightDate();
        createTheme();
        baseRowSize = rowSize = theme == null ? 70 : DisplayUtil.dip2px(getResources(),theme.dateHeight());
        smoothMode = theme == null ? 0 : theme.smoothMode();
        LogUtils.logd("currYear:"+currYear+"\t currMonth:"+currMonth+" currDay:"+currDay);
    }
...
//        NUM_ROWS =  getMonthRowNumber(year,month);
     ...
     * @return
     */
    public boolean isCalendarInfoNew(int year, int month, int day){
    ...
    private void doClickAction(int x,int y){
        ...
        oldSelectMonth = selMonth + 1;
    }
    protected int oldSelectMonth;
    /**
     * 左点击，日历向后翻页
     */
