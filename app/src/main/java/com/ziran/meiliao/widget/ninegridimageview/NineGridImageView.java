...
public class  NineGridImageView<T> extends ViewGroup {
    ...
    private ImageView getImageView(final int position) {
        if (position < mImageViewList.size()) {
            ...
            if (mAdapter != null) {
                GridImageView imageView = (GridImageView) mAdapter.generateImageView(getContext());
                mImageViewList.add(imageView);
                imageView.setOnDeleteClickListener(new GridImageView.OnDeleteClickListener() {
                    @Override
                    public void deleteClick() {
                        List newData = new ArrayList(mImgDataList);
    ...
    public ArrayList<Locations> getLocations() {
        ...
        for (int i = 0; i < mImageViewList.size(); i++) {
            ...
            locations.setIndex(i);
            locations.setLeft(location[0]);
            locations.setTop(location[1]);
            locations.setWidth(imageView.getWidth());
            locations.setHeight(imageView.getHeight());
    ...
    public static class Locations implements Parcelable {
        ...
        public String toString() {
            return "Locations{" + "left=" + left + ", top=" + top + ", height=" + height + ", width=" + width + ", index=" + index + '}';
        }
