...
public class CardSlidePanel extends ViewGroup {
    ...
    private RecommendUserBean.DataBean itemBean;
    private CardItemView mChanedView;

    public RecommendUserBean.DataBean getItemBean() {
        return itemBean;
    }

    public void setItemBean(RecommendUserBean.DataBean itemBean) {
    ...
    private void orderViewStack() {
        ...
        // 3. changedView填充新数据
        int newIndex = isShowing + 10;
        Log.e("newIndex",""+newIndex+"        "+adapter.getCount());
     ...
     */
    private void processLinkageView(CardItemView changedView) {
        mChanedView=changedView;
