package com.ziran.meiliao.widget.hellocharts.util;
...
public abstract class ChartUtils {
    ...
    public static final int DEFAULT_COLOR = Color.parseColor("#45b000");
    public static final int DEFAULT_DARKEN_COLOR = Color.parseColor("#507E7D");
