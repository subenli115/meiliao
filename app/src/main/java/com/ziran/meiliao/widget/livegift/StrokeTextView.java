...
public class StrokeTextView extends TextView {
    ...
    public StrokeTextView(Context context, AttributeSet attrs) {
       ...
       TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StrokeTextView);
        this.mInnerColor = a.getColor(R.styleable.StrokeTextView_stroke_textview_innnercolor,0xffffff);
        this.mOuterColor = a.getColor(R.styleable.StrokeTextView_stroke_textview_outercolor,0xffffff);
        a.recycle();
    }
