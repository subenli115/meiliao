...
public class WpyxDownloadUtil {

    private static WpyxDownloadUtil INSTANCE;
    private File file;

    private WpyxDownloadUtil() {
        Luban luban;
    }

    public static WpyxDownloadUtil get() {
        if (INSTANCE == null) {
            synchronized (WpyxDownloadUtil.class) {
                if (INSTANCE == null) {
                    INSTANCE = new WpyxDownloadUtil();
                }
            }
        }
        return INSTANCE;
