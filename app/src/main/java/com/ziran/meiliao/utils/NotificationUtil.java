...
public class NotificationUtil {
    ...
    private static final long TIMESTAMP_FIXED = 1234567890l;
    ...
    public static void createProgressNotification(Context context, String title, String content, int icon, int notifyId) {
        ...
        builder.setWhen(TIMESTAMP_FIXED);
...
//        final Notification notification_album_music = builderProgress.build();
//        final NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
//        //发送一个通知
//        notificationManager.notify(2, notification_album_music);
//        /**创建一个计时器,模拟下载进度**/
