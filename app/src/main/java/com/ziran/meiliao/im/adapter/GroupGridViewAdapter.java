...
import com.ziran.meiliao.im.activity.GroupGridViewActivity;
        ...
        if (position < mMemberList.size()) {
            ...
            if (!TextUtils.isEmpty(userInfo.getAvatar())) {
                ...
                if (file != null && file.isFile()) {
                    ...
                    Glide.with(mContext).load(bitmap).transform(new GlideCircleTransform(mContext)).into(viewTag.icon);
                } else {
