...
public class JGApplication extends com.activeandroid.app.Application {
    ...
    public static String getThumpPictureDir() {
        return THUMP_PICTURE_DIR;
    }

    public static void setThumpPictureDir(String thumpPictureDir) {
        THUMP_PICTURE_DIR = thumpPictureDir;
    }
