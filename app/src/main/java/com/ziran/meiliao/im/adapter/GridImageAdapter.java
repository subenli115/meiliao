...
public class GridImageAdapter extends
    ...
    private final AutoLinearLayout mallSelect;
    ...
    public GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener, AutoLinearLayout allSelect, RecyclerView recycler) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            if (chooseModel == PictureMimeType.ofAudio()) {
                viewHolder.mImg.setImageResource(R.drawable.picture_audio_placeholder);
                        ...
                        Glide.with(viewHolder.itemView.getContext()).load(PictureMimeType.isContent(path) && !media.isCut() && !media.isCompressed() ? Uri.parse(path)
                                : path).centerCrop().into(viewHolder.mImg);
