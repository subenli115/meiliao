...
public final class Calendar implements Serializable {
     ...
     * 是否是今天
     */
    private boolean isCurrentDayTwo;
    ...
    public boolean isCurrentDayTwo() {
        return isCurrentDayTwo;
    }
    public void setCurrentDay(boolean currentDay) {
        isCurrentDay = currentDay;
    }

    public void setCurrentDayTwo(boolean currentDay) {
        isCurrentDayTwo = currentDay;
    }
