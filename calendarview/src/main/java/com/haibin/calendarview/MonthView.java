...
import static com.haibin.calendarview.CalendarUtil.dipToPx;
...
public abstract class MonthView extends BaseView {
    ...
    private void draw(Canvas canvas, Calendar calendar, int i, int j, int d) {
        ...
        calendar.setDraw(true);
        onDrawbg(canvas, calendar, x, y, hasScheme);
        if (hasScheme) {
            ...
            if (isDrawSelected || !isSelected) {
                ...
                onDrawScheme(canvas, calendar, x, y,isDrawSelected,calendar.isDraw());
                if (isSelected) {
        ...
        onDrawText(canvas, calendar, x, y, hasScheme, isSelected,calendar.isDraw());
    }
     ...
     * @param x        日历Card x起点坐标
     * @param y        日历Card y起点坐标
     * @param isDrawSelected
     */
    protected abstract void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y, boolean isDrawSelected, boolean isDraw);
     ...
     * @param draw
     */
    protected abstract void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected, boolean draw);
}
