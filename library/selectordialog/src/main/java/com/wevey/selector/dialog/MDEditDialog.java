...
public class MDEditDialog implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    private void initDialog() {
        ...
        mEdit.setInputType(mBuilder.inputType);
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.edit_dialog_leftbtn && mBuilder.getListener() != null) {
            dismiss();
            mBuilder.getListener().clickLeftButton(mDialog,mLeftBtn, mEdit.getText().toString());
            return;
        }

        if (i == R.id.edit_dialog_rightbtn && mBuilder.getListener() != null) {

            mBuilder.getListener().clickRightButton(mDialog,mRightBtn, mEdit.getText().toString());
            return;
        }
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            isTouchOutside = true;
            hintText = "";
            hintTextColor = ContextCompat.getColor(mContext, R.color.gray2);
            lines = -1;
            maxLines = -1;
            maxLength = -1;
            height = 0.28f;
    ...
    public interface OnClickEditDialogListener {
        ...
        void clickLeftButton(Dialog dialog, View view, String editText);

        void clickRightButton(Dialog dialog,View view, String editText);
