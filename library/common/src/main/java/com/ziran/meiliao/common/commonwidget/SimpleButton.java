...
public class SimpleButton extends View {
    ...
    private void _init(Context context, AttributeSet attrs) {
        mBorderWidth = DisplayUtil.dp2px(context, 0.5f);
        mRadius = DisplayUtil.dp2px(context, 5f);
        mHorizontalPadding = (int) DisplayUtil.dp2px(context, 5f);
        mVerticalPadding = (int) DisplayUtil.dp2px(context, 5f);
        mIconPadding = (int) DisplayUtil.dp2px(context, 3f);
        mTextSize = DisplayUtil.sp2px(context.getResources(), 14f);
