package com.ziran.meiliao.common.statusbar;
 ...
 */
 ...
 class StatusBarCompat {
     ...
     */
    private static void setStatusBarColor(Activity activity, int color, boolean lightStatusBar) {
     ...
     * @param lightStatusBar if the status bar color is light. Only effective in some devices.
     */
    private static void setStatusBarColor(Window window, int color, boolean lightStatusBar) {
