...
public class AnimationUtil {
     ...
     */
    public static void startAnimationVer (final boolean showOrHide, final View view, boolean showAlpha, int duration, Animator.AnimatorListener animatorListener) {
        view.measure(0, 0);
        int tabLayoutHeight = view.getMeasuredHeight();
        final ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        ValueAnimator valueAnimator;
...
//        discAnimation.addListener(new SimpleAnimatorListener(){
//            @Override
//            public void onAnimationEnd(Animator animation) {
//                if (!showOrHide){
