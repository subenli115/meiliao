...
public class FileSizeUtil {
    ...
    public static String getAutoFileOrFilesSize(String... filePaths) {
        ...
        return Formatter.formatFileSize(BaseApplication.getAppContext(), totalSize);
    }
    ...
    public static String getAutoFileOrFilesSize(){
        return getAutoFileOrFilesSize(FileUtil.getExternalCacheDir(BaseApplication.getAppContext()),
                FileUtil.getInternalCacheDir(BaseApplication.getAppContext()));
    }
}
