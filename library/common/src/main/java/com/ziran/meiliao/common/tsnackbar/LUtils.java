...
public class LUtils {
    ...
    public int getStatusBarColor() {
        ...
        if (hasKitKat()) {
            ...
            if (statusBarView != null && statusBarView.getMeasuredHeight() == DisplayUtil.getStatusBarHeight(mActivity)) {
    ...
    public void setStatusBarColor(int color) {
        ...
        if (hasKitKat()) {
            ...
            ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                                                                   DisplayUtil.getStatusBarHeight(mActivity));
            statusBarView.setBackgroundColor(color);
    ...
    public void setStatusBarColorL(int color) {
        ...
        ViewGroup.LayoutParams lp =
                new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DisplayUtil.getStatusBarHeight(mActivity));
        statusBarView.setBackgroundColor(color);
        contentView.addView(statusBarView, 0, lp);
    }
